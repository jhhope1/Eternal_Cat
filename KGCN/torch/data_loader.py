...
def load_rating(args):
    ...
    # reading rating file
    #rating_file = os.path.dirname(__file__) + args
    rating_file = os.path.join(DATA , args.dataset , 'ratings_final')
    #rating_file = os.path.join(DATA , 'music' , 'ratings_final')
...
def load_kg(args):
    ...
    # reading kg file
    kg_file = os.path.join(DATA, args.dataset, 'kg_final')
...
_, __, t_data, e_data, test_data = load_rating(args)
print('a')
'''